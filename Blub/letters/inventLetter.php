            ...
            <form name="inventLetter" action="inventLetterBackend.php" method="post">
                <div class="main-content container-fluid p-0">
                    <div class="email-head">
                        <div class="email-head-title">Verfasse einen neuen Brief<span class="icon mdi mdi-edit"></span></div>
                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="readableByDate" data-target="#datetimepicker4" />
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="readableByTime" data-target="#datetimepicker3" />
                    ...
                    <div class="email editor">
                        <div class="col-md-12 p-0">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="summernote" name="letter" rows="6" placeholder="Write Descriptions"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 p-0">
                            <div class="form-group">
                        ...
                        <div class="email action-send">
                            <div class="col-md-12 ">
                                <div class="form-group">
                                    <button class="btn btn-primary btn-space" type="submit"><i class="icon s7-mail"></i> Speichern</button>
                                    <a class="btn btn-secondary btn-space" href="inventLetter.php"><i class="icon s7-close"></i> Verwerfen</a>
                                </div>
                            </div>
                        </div>
                    </div>
